<template>
	<MakeProblem listEndLabel="c" :listItemScoreTexts="['(5 points)', '(5 points)', '(5 points)']">
		<template #problem>
		...
		<template #a>Finish above process and determine $q_2$ and $q_3$, and fill in the columns of $Q$.</template>
		<template #b>Finish above process and determine $R$.</template>
		<template #c>Use the $QR$ factorization to find the least squares solution to $Ax = b$.</template>
	</MakeProblem>
</template>
