...
const testData = {
	...
	".toStr": {
		...
		tests: [ // 測資
			...
			{ input: [1, 0, -2], output: "± 1 √ 2" },
			{ input: [1, 0, 2], output: "± 1 √ 2 i" },
			{ input: [1, 0, 9], output: "± 3 i" },
			{ input: [4, 16, 5], output: "-2 ± 1/2 √ 11" },
			{ input: [F(77, 32), F(-56, 13), F(34, 71)], output: "128/143 ± 8/71071 √ 47527613" },
			{ input: [4, 2, 5], output: "-1/4 ± 1/4 √ 19 i" },
			{ input: [4, 16, 5.2], output: "-0.3568 , -3.6432" },
			{ input: [4, 2, 5.2], output: "-0.2500 ± 1.1124 i" },
		],
	},
	".toLatex": {
