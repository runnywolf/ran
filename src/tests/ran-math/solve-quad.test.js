...
// ---------- test area ----------
import { isInt, F, Frac, EF, SolveQuad } from "ran-math";
...
const testData = {
	"SolveQuad": {
		...
		tests: [ // 測資
			{ input: [1, -1, -6], output: [SolveQuad.TYPE_2_FRAC, new EF(-2), new EF(3)] }, // TYPE_2_FRAC * 5
			{ input: [5, F(-22, 3), F(8, 3)], output: [SolveQuad.TYPE_2_FRAC, new EF(F(2, 3)), new EF(F(4, 5))] },
			{ input: [1, F(41319, 20987), F(-12006, 20987)], output: [SolveQuad.TYPE_2_FRAC, new EF(F(-69, 31)), new EF(F(174, 677))] },
			{ input: [1, -1, 0], output: [SolveQuad.TYPE_2_FRAC, new EF(0), new EF(1)] },
			...
			{
				input: [4, 16, 5.2],
				output: [SolveQuad.TYPE_2_REAL, new EF(-3.6431676725154984), new EF(-0.35683232748450155)]
			},
			{
				input: [4, 2, 5.2],
	...
	".toStr": {
		...
		tests: [ // 測資
			{ input: [1, -1, -6], output: "-2 , 3" }, // TYPE_2_FRAC * 5
			{ input: [5, F(-22, 3), F(8, 3)], output: "2/3 , 4/5" },
			{ input: [1, F(41319, 20987), F(-12006, 20987)], output: "-69/31 , 174/677" },
			...
			{ input: [4, 16, 5.2], output: "-3.6432 , -0.3568" },
